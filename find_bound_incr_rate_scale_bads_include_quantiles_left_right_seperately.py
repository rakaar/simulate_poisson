...
def compute_quantiles_from_rt_data(rt_data, quantiles=[0.1, 0.3, 0.5, 0.7, 0.9]):
    ...
    Parameters:
        ...
        quantiles: List of quantiles to compute (default: 10th, 30th, 50th, 70th, 90th percentiles)
...
def compute_ddm_predictions(original_theta, n_trials=N_sim_ddm_quantiles):
    ...
    Uses simulations to compute 10th, 30th, 50th, 70th, and 90th percentile RTs.
    ...
    Returns:
        ddm_quantiles_data: dict with keys (ABL, ILD) and values = array of [q10, q30, q50, q70, q90] RT quantiles
...
def run_poisson_simulations_get_all(Nr0_scaled_right, Nr0_scaled_left, theta_poisson, ABL, ILD, n_trials=N_sim_poisson_quantiles):
    ...
    Returns:
        ...
        quantiles: Array of [q10, q30, q50, q70, q90] RT quantiles
...
def objective_function_rate_bound(x, original_theta, ddm_quantiles_data, ddm_acc_data, verbose=False):
    ...
    # Sum of squared errors across all 5 quantiles (10th, 30th, 50th, 70th, 90th) for all stimuli
    ...
    for ABL in ABL_range:
        for ILD in ILD_range:
            ...
            # Sum squared errors for all 5 quantiles
            for i in range(5):
