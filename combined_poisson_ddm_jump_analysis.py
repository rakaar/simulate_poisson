...
ax1.set_title(
    f'Reaction Time Distributions: Poisson vs DDM\n'
    f'N = {N_right_and_left}, r_R = {r_right:.4f}, r_L = {r_left:.4f}, '
    f'N*r_R = {N_right*r_right:.2f}, N*r_L = {N_left*r_left:.2f}\n'
    f'corr = {c:.4f}, corr_factor = {corr_factor:.3f}, theta = {theta}, mu = {mu:.2f}, sigma = {sigma:.2f}',
